...
async function productSeeders() {
  ...
  const newProduct = [
...

    {
      ...
      description:
        "The illuminated touch dimmer is easy to find not only during the day but also at night. Immerse yourself in a world of possibilities by choosing from three colors and different brightness levels. Enjoy clear vision and say goodbye to annoying fogging thanks to the anti-fog system.",
...

    {
      ...
      description:
        "This fire pit, MADE IN GERMANY, is a multifunctional decorative element for your outdoor area. Enjoy the crackling flames of an open fire and prepare delicious breadsticks on the coals. It can be flexibly installed anywhere in the garden or outdoor area; the split top and bottom construction allows for easy placement. Thanks to the lack of a drainage hole, there are no unsightly water stains on the surface.",
